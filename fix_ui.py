...
imports = """import io.github.dsheirer.playlist.PlaylistManager;
...
content = content.replace("package io.github.dsheirer.gui.playlist.twotone;\n", "package io.github.dsheirer.gui.playlist.twotone;\n\n" + imports)
...
content = re.sub(r'\{[\s\S]+?\}\s*\}', class_body, content, count=1)
